...
> Highlighted Coursework: Machine Learning in Environmental Science, Databases and Data Management, Modeling Environmental Systems, Statistics for Environmental Data Science 
(All to be completed by June 2023)
...
**Languages**: Spanish, R(tidyverse), Python(Pandsas,Scipy), SQL, Matlab

**Environments**: Rstudio,Quarto ArcPro, Qgis

**Technical**: Data Visualization, Machine Learning
